			...
			<div class="page-header">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Database Siswa <?= $this->session->userdata('nama').$this->session->userdata('sekolah').$this->session->userdata('jurusan').$this->session->userdata('tahun_akademik') ?></h4>
