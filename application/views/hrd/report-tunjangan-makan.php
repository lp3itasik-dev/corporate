...
<head>
	...
	<title>Politeknik LP3I Kampus Tasikmalaya - Report Tunjangan Makan</title>
			...
			<div class="page-header">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-file-empty mr-2"></i> <span class="font-weight-semibold">Report</span> - Tunjangan Makan</h4>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title"><i class="icon-search4"></i> &nbsp; Search For Tunjangan Makan</h6>
							</div>

							<div class="card-body">
								<form action="<?= base_url() ?>Hrd/CetakTunjanganMakan" method="GET" target="_blank">
